...
| [GG555-13](https://github.com/GG555-13) | Entrevista com PO. (Costa) para elaboração de um modelo de entidades. 2. Elaboração do ME-R. 3. Revisão de artefatos | Excelente |
...
| [ArturRSA19](https://github.com/ArturRSA19) |-| -|
| [GuilhermeBES](https://github.com/GuilhermeBES) | -| - |
| [GG555-13](https://github.com/GG555-13) |  1. elaboração do código e arquivo .md do Observer-Visitor-Bridge, 2.criação de vídeos de demostração de código de todos os códigos de reutilização, 3.Revição de artefatos | excelente |
| [guilhermesoaress](https://github.com/guilhermesoaress) |  - | - |
