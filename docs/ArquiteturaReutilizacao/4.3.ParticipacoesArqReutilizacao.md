...
| [guilhermesoaress](https://github.com/guilhermesoaress) |  1. Elaboração da documentação do projeto no GitHub e GitPages. 2. Participação em discussões no WhatsApp| Boa |
...
| [guilhermesoaress](https://github.com/guilhermesoaress) |  1. Criação do documento de documentação da descrição do MVP. 2. Criação de imagens e textos para exibir o desenvolvimento do MVP no GitPages.| Boa |
