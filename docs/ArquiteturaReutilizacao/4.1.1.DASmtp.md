...
## O documento em questão foi criado e desenvolvido pelos alunos [Mateus Orlando](https://github.com/MateusPy), [Pedro Lucas](https://github.com/AlefMemTav) e [Thiago Vivan](https://github.com/thiago-vivan). Para a sua criação, cada aluno fez um ou mais visões, segue a tabela:
